...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create iotm-app-f70f
  fly apps create iotm-app-f70f-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app iotm-app-f70f
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app iotm-app-f70f-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'iotm-app-f70f-staging' does not match app name in config file 'iotm-app-f70f'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name iotm-app-f70f-db
  fly postgres attach --app iotm-app-f70f iotm-app-f70f-db

  fly postgres create --name iotm-app-f70f-staging-db
  fly postgres attach --app iotm-app-f70f-staging iotm-app-f70f-staging-db
  ```
